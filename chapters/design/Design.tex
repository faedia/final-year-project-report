...
There is an example provided to the user of how to do this using Haskell Data Maps\todo{cite data maps} so that the user is not on their own in this regard.
