...
We have discussed briefly whether JET met our criteria for success, however, now we will discuss in detail each required feature in our list of aims given in \autoref{itms:aims}.
